...
#
# The original project talked to a local Ollama server running llama3.2:3b.
# That's not reachable from a hosted environment (e.g. Hugging Face Spaces),
# so this version talks to a cloud LLM through an OpenAI-compatible API
# instead. It defaults to Groq's free tier (no credit card required, fast
