...
1. The system uses a cloud LLM API. 🦙
...
The application uses a cloud-hosted LLM.
The RAG mode can be changed using the sidebar.

### 3. Is my uploaded data safe?

Uploaded resume data is processed by this application and sent to the configured LLM API provider for generation.
...
The retrieved resumes are then provided to the LLM as context for analysis and summarization.
"""
...
This project demonstrates a RAG-based approach to resume screening using semantic retrieval and a cloud LLM.

The system combines FAISS vector search, sentence-transformer embeddings, RAG Fusion, and a cloud language model to assist with resume analysis.
